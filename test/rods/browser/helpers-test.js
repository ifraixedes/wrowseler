...
describe('Browser rods base functions', function () {
  ...
  /************************* hey you*/
  describe('`injectAsyncScriptBlock`', function () {
    describe('when called without options and without arguments', function () {
      var scriptBlock, wbChrome, stub;
      ...
      before(function () {
        ...
        rods.injectAsyncScriptBlock(wbChrome, scriptBlock, 'execMe');
      });
    ...
    describe('when called without options and with arguments', function () {
      ...
      before(function () {
        ...
        rods.injectAsyncScriptBlock(wbChrome, scriptBlock, 'execMe', 'argument 1', 'argument 2');
      });
    ...
    describe('when called with the option `callbackName` to "myDone" and without arguments', function () {
      ...
      before(function () {
        ...
        rods.injectAsyncScriptBlock(wbChrome, { callbackName: 'myDone' }, scriptBlock, 'execMe');
      });
    ...
    describe('when called with the option `callbackName` to "myDone" and with arguments', function () {
      ...
      before(function () {
        ...
        rods.injectAsyncScriptBlock(wbChrome, { callbackName: 'myDone' }, scriptBlock, 'execMe', 'argument 1', 'argument 2');
      });
